					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:3px">
						...
						<tr><td>
							...
							<div align="center" class="plugincolhd">
								<b><small><?php if ($obj->debrid_mode) {echo count($debrid);} else {echo count($host);}?></small></b> <?php printf($obj->lang['plugins']); ?>
							</div>
			...
			<table width="60%" align="center" cellpadding="0" cellspacing="0">
				<tr><td>
					...
					<!-- Copyright please don't remove-->
						<STRONG><SPAN class='powered'>Based on <a href='https://github.com/giaythuytinh176/vinaget-script'>Vinaget 2.7.0 Final</a> by [FZ]<br/>
						Rebuild code by ♥LTT♥ & enc0d3.</SPAN><br/>
